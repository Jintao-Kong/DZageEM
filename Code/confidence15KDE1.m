%% yield sigmaage k = 15
function [sigmaage,sigmaall] = confidence15KDE1(data,weight,group,sigma)
...
sigma11 = (sum(sigma111)+sum(sigma112)-2.*Likelihood15)./(deltaage.^2);
...
sigma22 = (sum(sigma221)+sum(sigma222)-2.*Likelihood15)./(deltaweight.^2);
...
sigma33 = (sum(sigma331)+sum(sigma332)-2.*Likelihood15)./(deltaage.^2);
...
sigma44 = (sum(sigma441)+sum(sigma442)-2.*Likelihood15)./(deltaweight.^2);
...
sigma55 = (sum(sigma551)+sum(sigma552)-2.*Likelihood15)./(deltaage.^2);
...
sigma66 = (sum(sigma661)+sum(sigma662)-2.*Likelihood15)./(deltaweight.^2);
...
sigma77 = (sum(sigma771)+sum(sigma772)-2.*Likelihood15)./(deltaage.^2);
...
sigma88 = (sum(sigma881)+sum(sigma882)-2.*Likelihood15)./(deltaweight.^2);
...
sigma99 = (sum(sigma991)+sum(sigma992)-2.*Likelihood15)./(deltaage.^2);
...
sigma1010 = (sum(sigma10101)+sum(sigma10102)-2.*Likelihood15)./(deltaweight.^2);
...
sigma1111 = (sum(sigma11111)+sum(sigma11112)-2.*Likelihood15)./(deltaage.^2);
...
sigma1212 = (sum(sigma12121)+sum(sigma12122)-2.*Likelihood15)./(deltaweight.^2);
...
sigma1313 = (sum(sigma13131)+sum(sigma13132)-2.*Likelihood15)./(deltaage.^2);
...
sigma1414 = (sum(sigma14141)+sum(sigma14142)-2.*Likelihood15)./(deltaweight.^2);
...
sigma1515 = (sum(sigma15151)+sum(sigma15152)-2.*Likelihood15)./(deltaage.^2);
...
sigma1616 = (sum(sigma16161)+sum(sigma16162)-2.*Likelihood15)./(deltaweight.^2);
...
sigma1717 = (sum(sigma17171)+sum(sigma17172)-2.*Likelihood15)./(deltaage.^2);
...
sigma1818 = (sum(sigma18181)+sum(sigma18182)-2.*Likelihood15)./(deltaweight.^2);
...
sigma1919 = (sum(sigma19191)+sum(sigma19192)-2.*Likelihood15)./(deltaage.^2);
...
sigma2020 = (sum(sigma20201)+sum(sigma20202)-2.*Likelihood15)./(deltaweight.^2);
...
sigma2121 = (sum(sigma21211)+sum(sigma21212)-2.*Likelihood15)./(deltaage.^2);
...
sigma2222 = (sum(sigma22221)+sum(sigma22222)-2.*Likelihood15)./(deltaweight.^2);
...
sigma2323 = (sum(sigma23231)+sum(sigma23232)-2.*Likelihood15)./(deltaage.^2);
...
sigma2424 = (sum(sigma24241)+sum(sigma24242)-2.*Likelihood15)./(deltaweight.^2);
...
sigma2525 = (sum(sigma25251)+sum(sigma25252)-2.*Likelihood15)./(deltaage.^2);
...
sigma2626 = (sum(sigma26261)+sum(sigma26262)-2.*Likelihood15)./(deltaweight.^2);
...
sigma2727 = (sum(sigma27271)+sum(sigma27272)-2.*Likelihood15)./(deltaage.^2);
...
sigma2828 = (sum(sigma28281)+sum(sigma28282)-2.*Likelihood15)./(deltaweight.^2);
...
sigma2929 = (sum(sigma29291)+sum(sigma29292)-2.*Likelihood15)./(deltaage.^2);
...
sigma3030 = (sum(sigma30301)+sum(sigma30302)-2.*Likelihood15)./(deltaweight.^2);
...
sigma = [sigma11;sigma22;sigma33;sigma44;sigma55;sigma66;sigma77;sigma88;sigma99;sigma1010;sigma1111;...
    ...
    sigma2222;sigma2323;sigma2424;sigma2525;sigma2626;sigma2727;sigma2828;sigma2929;sigma3030];
