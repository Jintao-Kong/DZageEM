%k=18;KDE
function [weight18age_KDE, sigma18age_KDE, group18age_KDE, BIC18_KDE]...
    = ML18KDE (data,initialgroup,iteration)
% initial number need to be checked
initialweight = ones(1,18).*(1/18);
initialsigma = ones(1,18).*15;
...
for i = 1:iteration
    ...
    alphadensity(:,19) = alphadensity(:,1) + alphadensity(:,2) + alphadensity(:,3) + alphadensity(:,4)...
        ...
        + alphadensity(:,10) + alphadensity(:,11) + alphadensity(:,12) + alphadensity(:,13) + alphadensity(:,14)...
         + alphadensity(:,15) + alphadensity(:,16) + alphadensity(:,17) + alphadensity(:,18);parameter = 2*18 * (2/3);
    
    a = alphadensity(:,1)./alphadensity(:,19); a1 = a((~isnan(a)));
    b = alphadensity(:,2)./alphadensity(:,19); b1 = b((~isnan(b)));
    c = alphadensity(:,3)./alphadensity(:,19); c1 = c((~isnan(c)));
    d = alphadensity(:,4)./alphadensity(:,19); d1 = d((~isnan(d)));
    e = alphadensity(:,5)./alphadensity(:,19); e1 = e((~isnan(e)));
    f = alphadensity(:,6)./alphadensity(:,19); f1 = f((~isnan(f)));
    g = alphadensity(:,7)./alphadensity(:,19); g1 = g((~isnan(g)));
    h = alphadensity(:,8)./alphadensity(:,19); h1 = h((~isnan(h)));
    j = alphadensity(:,9)./alphadensity(:,19); j1 = j((~isnan(j)));
    k = alphadensity(:,10)./alphadensity(:,19); k1 = k((~isnan(k)));
    L = alphadensity(:,11)./alphadensity(:,19); L1 = L((~isnan(L)));
    m = alphadensity(:,12)./alphadensity(:,19); m1 = m((~isnan(m)));
    thirteen = alphadensity(:,13)./alphadensity(:,19); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = alphadensity(:,14)./alphadensity(:,19); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = alphadensity(:,15)./alphadensity(:,19); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = alphadensity(:,16)./alphadensity(:,19); sixteen1 = sixteen((~isnan(sixteen)));
    seventeen = alphadensity(:,17)./alphadensity(:,19); seventeen1 = seventeen((~isnan(seventeen)));
    eightteen = alphadensity(:,18)./alphadensity(:,19); eightteen1 = eightteen((~isnan(eightteen)));
    ...
    miudensity1(:,19) = miudensity1(:,1) + miudensity1(:,2) + miudensity1(:,3) + miudensity1(:,4)...
        ...
        + miudensity1(:,10) + miudensity1(:,11) + miudensity1(:,12) + miudensity1(:,13) + miudensity1(:,14)...
         + miudensity1(:,15) + miudensity1(:,16) + miudensity1(:,17) + miudensity1(:,18);
    
    a = miudensity1(:,1)./miudensity1(:,19); a1 = a((~isnan(a)));
    b = miudensity1(:,2)./miudensity1(:,19); b1 = b((~isnan(b)));
    c = miudensity1(:,3)./miudensity1(:,19); c1 = c((~isnan(c)));
    d = miudensity1(:,4)./miudensity1(:,19); d1 = d((~isnan(d)));
    e = miudensity1(:,5)./miudensity1(:,19); e1 = e((~isnan(e)));
    f = miudensity1(:,6)./miudensity1(:,19); f1 = f((~isnan(f)));
    g = miudensity1(:,7)./miudensity1(:,19); g1 = g((~isnan(g)));
    h = miudensity1(:,8)./miudensity1(:,19); h1 = h((~isnan(h)));
    j = miudensity1(:,9)./miudensity1(:,19); j1 = j((~isnan(j)));
    k = miudensity1(:,10)./miudensity1(:,19); k1 = k((~isnan(k)));
    L = miudensity1(:,11)./miudensity1(:,19); L1 = L((~isnan(L)));
    m = miudensity1(:,12)./miudensity1(:,19); m1 = m((~isnan(m)));
    thirteen = miudensity1(:,13)./miudensity1(:,19); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = miudensity1(:,14)./miudensity1(:,19); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = miudensity1(:,15)./miudensity1(:,19); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = miudensity1(:,16)./miudensity1(:,19); sixteen1 = sixteen((~isnan(sixteen)));
    seventeen = miudensity1(:,17)./miudensity1(:,19); seventeen1 = seventeen((~isnan(seventeen)));
    eightteen = miudensity1(:,18)./miudensity1(:,19); eightteen1 = eightteen((~isnan(eightteen)));
    ...
    a = miudensity2(:,1)./miudensity1(:,19); a1 = a((~isnan(a)));
    b = miudensity2(:,2)./miudensity1(:,19); b1 = b((~isnan(b)));
    c = miudensity2(:,3)./miudensity1(:,19); c1 = c((~isnan(c)));
    d = miudensity2(:,4)./miudensity1(:,19); d1 = d((~isnan(d)));
    e = miudensity2(:,5)./miudensity1(:,19); e1 = e((~isnan(e)));
    f = miudensity2(:,6)./miudensity1(:,19); f1 = f((~isnan(f)));
    g = miudensity2(:,7)./miudensity1(:,19); g1 = g((~isnan(g)));
    h = miudensity2(:,8)./miudensity1(:,19); h1 = h((~isnan(h)));
    j = miudensity2(:,9)./miudensity1(:,19); j1 = j((~isnan(j)));
    k = miudensity2(:,10)./miudensity1(:,19); k1 = k((~isnan(k)));
    L = miudensity2(:,11)./miudensity1(:,19); L1 = L((~isnan(L)));
    m = miudensity2(:,12)./miudensity1(:,19); m1 = m((~isnan(m)));
    thirteen = miudensity2(:,13)./miudensity1(:,19); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = miudensity2(:,14)./miudensity1(:,19); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = miudensity2(:,15)./miudensity1(:,19); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = miudensity2(:,16)./miudensity1(:,19); sixteen1 = sixteen((~isnan(sixteen)));
    seventeen = miudensity2(:,17)./miudensity1(:,19); seventeen1 = seventeen((~isnan(seventeen)));
    eightteen = miudensity2(:,18)./miudensity1(:,19); eightteen1 = eightteen((~isnan(eightteen)));
    ...
    sdensity1(:,19) = sdensity1(:,1) + sdensity1(:,2) + sdensity1(:,3) + sdensity1(:,4)...
        ...
        + sdensity1(:,10) + sdensity1(:,11) + sdensity1(:,12) + sdensity1(:,13) + sdensity1(:,14)...
         + sdensity1(:,15) + sdensity1(:,16) + sdensity1(:,17) + sdensity1(:,18);
    
    a = sdensity1(:,1)./sdensity1(:,19); a1 = a((~isnan(a)));
    b = sdensity1(:,2)./sdensity1(:,19); b1 = b((~isnan(b)));
    c = sdensity1(:,3)./sdensity1(:,19); c1 = c((~isnan(c)));
    d = sdensity1(:,4)./sdensity1(:,19); d1 = d((~isnan(d)));
    e = sdensity1(:,5)./sdensity1(:,19); e1 = e((~isnan(e)));
    f = sdensity1(:,6)./sdensity1(:,19); f1 = e((~isnan(f)));
    g = sdensity1(:,7)./sdensity1(:,19); g1 = g((~isnan(g)));
    h = sdensity1(:,8)./sdensity1(:,19); h1 = h((~isnan(h)));
    j = sdensity1(:,9)./sdensity1(:,19); j1 = j((~isnan(j)));
    k = sdensity1(:,10)./sdensity1(:,19); k1 = k((~isnan(k)));
    L = sdensity1(:,11)./sdensity1(:,19); L1 = L((~isnan(L))); 
    m = sdensity1(:,12)./sdensity1(:,19); m1 = m((~isnan(m))); 
    thirteen = sdensity1(:,13)./sdensity1(:,19); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = sdensity1(:,14)./sdensity1(:,19); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = sdensity1(:,15)./sdensity1(:,19); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = sdensity1(:,16)./sdensity1(:,19); sixteen1 = sixteen((~isnan(sixteen)));
    seventeen = sdensity1(:,17)./sdensity1(:,19); seventeen1 = seventeen((~isnan(seventeen)));
    eightteen = sdensity1(:,18)./sdensity1(:,19); eightteen1 = eightteen((~isnan(eightteen)));
    ...
    a = sdensity2(:,1)./sdensity1(:,19); a1 = a((~isnan(a)));
    b = sdensity2(:,2)./sdensity1(:,19); b1 = b((~isnan(b)));
    c = sdensity2(:,3)./sdensity1(:,19); c1 = c((~isnan(c)));
    d = sdensity2(:,4)./sdensity1(:,19); d1 = d((~isnan(d)));
    e = sdensity2(:,5)./sdensity1(:,19); e1 = e((~isnan(e)));
    f = sdensity2(:,6)./sdensity1(:,19); f1 = f((~isnan(f)));
    g = sdensity2(:,7)./sdensity1(:,19); g1 = g((~isnan(g)));
    h = sdensity2(:,8)./sdensity1(:,19); h1 = h((~isnan(h)));
    j = sdensity2(:,9)./sdensity1(:,19); j1 = j((~isnan(j)));
    k = sdensity2(:,10)./sdensity1(:,19); k1 = k((~isnan(k)));
    L = sdensity2(:,11)./sdensity1(:,19); L1 = L((~isnan(L)));
    m = sdensity2(:,12)./sdensity1(:,19); m1 = m((~isnan(m)));
    thirteen = sdensity2(:,13)./sdensity1(:,19); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = sdensity2(:,14)./sdensity1(:,19); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = sdensity2(:,15)./sdensity1(:,19); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = sdensity2(:,16)./sdensity1(:,19); sixteen1 = sixteen((~isnan(sixteen)));
    seventeen = sdensity2(:,17)./sdensity1(:,19); seventeen1 = seventeen((~isnan(seventeen)));
    eightteen = sdensity2(:,18)./sdensity1(:,19); eightteen1 = eightteen((~isnan(eightteen)));
...
group18age_KDE = parameters_sort(:,1);
weight18age_KDE = parameters_sort(:,2);
sigma18age_KDE = parameters_sort(:,3);

no = 18;

result = log(weight18age_KDE(1).*distribution(data(:,1),sigma18age_KDE(1),group18age_KDE(1))+...
    weight18age_KDE(2).*distribution(data(:,1),sigma18age_KDE(2),group18age_KDE(2))+...
    weight18age_KDE(3).*distribution(data(:,1),sigma18age_KDE(3),group18age_KDE(3))+...
    weight18age_KDE(4).*distribution(data(:,1),sigma18age_KDE(4),group18age_KDE(4))+...
    weight18age_KDE(5).*distribution(data(:,1),sigma18age_KDE(5),group18age_KDE(5))+...
    weight18age_KDE(6).*distribution(data(:,1),sigma18age_KDE(6),group18age_KDE(6))+...
    weight18age_KDE(7).*distribution(data(:,1),sigma18age_KDE(7),group18age_KDE(7))+...
    weight18age_KDE(8).*distribution(data(:,1),sigma18age_KDE(8),group18age_KDE(8))+...
    weight18age_KDE(9).*distribution(data(:,1),sigma18age_KDE(9),group18age_KDE(9))+...
    weight18age_KDE(10).*distribution(data(:,1),sigma18age_KDE(10),group18age_KDE(10))+...
    weight18age_KDE(11).*distribution(data(:,1),sigma18age_KDE(11),group18age_KDE(11))+...
    weight18age_KDE(12).*distribution(data(:,1),sigma18age_KDE(12),group18age_KDE(12))+...
    weight18age_KDE(13).*distribution(data(:,1),sigma18age_KDE(13),group18age_KDE(13))+...
    weight18age_KDE(14).*distribution(data(:,1),sigma18age_KDE(14),group18age_KDE(14))+...
    weight18age_KDE(15).*distribution(data(:,1),sigma18age_KDE(15),group18age_KDE(15))+...
    weight18age_KDE(16).*distribution(data(:,1),sigma18age_KDE(16),group18age_KDE(16))+...
    weight18age_KDE(17).*distribution(data(:,1),sigma18age_KDE(17),group18age_KDE(17))+...
    weight18age_KDE(18).*distribution(data(:,1),sigma18age_KDE(18),group18age_KDE(18)));

result1 = result((~isinf(result)));

Likelihood18KDE = sum(result1);

BIC18_KDE = -2*Likelihood18KDE+parameter*log(n);
end