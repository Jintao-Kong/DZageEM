%k=13;KDE
function [weight13age_KDE, sigma13age_KDE, group13age_KDE, BIC13_KDE]...
    = ML13KDE (data,initialgroup,iteration)
% initial number need to be checked
initialweight = ones(1,13).*(1/13);
initialsigma = ones(1,13).*15;
...
for i = 1:iteration
    ...
    alphadensity(:,14) = alphadensity(:,1) + alphadensity(:,2) + alphadensity(:,3) + alphadensity(:,4)...
        + alphadensity(:,5) + alphadensity(:,6) + alphadensity(:,7) + alphadensity(:,8) + alphadensity(:,9)...
        + alphadensity(:,10) + alphadensity(:,11) + alphadensity(:,12) + alphadensity(:,13);
    
    a = alphadensity(:,1)./alphadensity(:,14); a1 = a((~isnan(a)));
    b = alphadensity(:,2)./alphadensity(:,14); b1 = b((~isnan(b)));
    c = alphadensity(:,3)./alphadensity(:,14); c1 = c((~isnan(c)));
    d = alphadensity(:,4)./alphadensity(:,14); d1 = d((~isnan(d)));
    e = alphadensity(:,5)./alphadensity(:,14); e1 = e((~isnan(e)));
    f = alphadensity(:,6)./alphadensity(:,14); f1 = f((~isnan(f)));
    g = alphadensity(:,7)./alphadensity(:,14); g1 = g((~isnan(g)));
    h = alphadensity(:,8)./alphadensity(:,14); h1 = h((~isnan(h)));
    j = alphadensity(:,9)./alphadensity(:,14); j1 = j((~isnan(j)));
    k = alphadensity(:,10)./alphadensity(:,14); k1 = k((~isnan(k)));
    L = alphadensity(:,11)./alphadensity(:,14); L1 = L((~isnan(L)));
    m = alphadensity(:,12)./alphadensity(:,14); m1 = m((~isnan(m)));
    thirteen = alphadensity(:,13)./alphadensity(:,14); thirteen1 = thirteen((~isnan(thirteen)));
    ...
    miudensity1(:,14) = miudensity1(:,1) + miudensity1(:,2) + miudensity1(:,3) + miudensity1(:,4)...
        + miudensity1(:,5) + miudensity1(:,6) + miudensity1(:,7) + miudensity1(:,8) + miudensity1(:,9)...
        + miudensity1(:,10) + miudensity1(:,11) + miudensity1(:,12) + miudensity1(:,13);
    
    a = miudensity1(:,1)./miudensity1(:,14); a1 = a((~isnan(a)));
    b = miudensity1(:,2)./miudensity1(:,14); b1 = b((~isnan(b)));
    c = miudensity1(:,3)./miudensity1(:,14); c1 = c((~isnan(c)));
    d = miudensity1(:,4)./miudensity1(:,14); d1 = d((~isnan(d)));
    e = miudensity1(:,5)./miudensity1(:,14); e1 = e((~isnan(e)));
    f = miudensity1(:,6)./miudensity1(:,14); f1 = f((~isnan(f)));
    g = miudensity1(:,7)./miudensity1(:,14); g1 = g((~isnan(g)));
    h = miudensity1(:,8)./miudensity1(:,14); h1 = h((~isnan(h)));
    j = miudensity1(:,9)./miudensity1(:,14); j1 = j((~isnan(j)));
    k = miudensity1(:,10)./miudensity1(:,14); k1 = k((~isnan(k)));
    L = miudensity1(:,11)./miudensity1(:,14); L1 = L((~isnan(L)));
    m = miudensity1(:,12)./miudensity1(:,14); m1 = m((~isnan(m)));
    thirteen = miudensity1(:,13)./miudensity1(:,14); thirteen1 = thirteen((~isnan(thirteen)));
    ...
    a = miudensity2(:,1)./miudensity1(:,14); a1 = a((~isnan(a)));
    b = miudensity2(:,2)./miudensity1(:,14); b1 = b((~isnan(b)));
    c = miudensity2(:,3)./miudensity1(:,14); c1 = c((~isnan(c)));
    d = miudensity2(:,4)./miudensity1(:,14); d1 = d((~isnan(d)));
    e = miudensity2(:,5)./miudensity1(:,14); e1 = e((~isnan(e)));
    f = miudensity2(:,6)./miudensity1(:,14); f1 = f((~isnan(f)));
    g = miudensity2(:,7)./miudensity1(:,14); g1 = g((~isnan(g)));
    h = miudensity2(:,8)./miudensity1(:,14); h1 = h((~isnan(h)));
    j = miudensity2(:,9)./miudensity1(:,14); j1 = j((~isnan(j)));
    k = miudensity2(:,10)./miudensity1(:,14); k1 = k((~isnan(k)));
    L = miudensity2(:,11)./miudensity1(:,14); L1 = L((~isnan(L)));
    m = miudensity2(:,12)./miudensity1(:,14); m1 = m((~isnan(m)));
    thirteen = miudensity2(:,13)./miudensity1(:,14); thirteen1 = thirteen((~isnan(thirteen)));
    ...
    sdensity1(:,14) = sdensity1(:,1) + sdensity1(:,2) + sdensity1(:,3) + sdensity1(:,4)...
        + sdensity1(:,5) + sdensity1(:,6) + sdensity1(:,7) + sdensity1(:,8) + sdensity1(:,9)...
        + sdensity1(:,10) + sdensity1(:,11) + sdensity1(:,12) + sdensity1(:,13);
    
    a = sdensity1(:,1)./sdensity1(:,14); a1 = a((~isnan(a)));
    b = sdensity1(:,2)./sdensity1(:,14); b1 = b((~isnan(b)));
    c = sdensity1(:,3)./sdensity1(:,14); c1 = c((~isnan(c)));
    d = sdensity1(:,4)./sdensity1(:,14); d1 = d((~isnan(d)));
    e = sdensity1(:,5)./sdensity1(:,14); e1 = e((~isnan(e)));
    f = sdensity1(:,6)./sdensity1(:,14); f1 = e((~isnan(f)));
    g = sdensity1(:,7)./sdensity1(:,14); g1 = g((~isnan(g)));
    h = sdensity1(:,8)./sdensity1(:,14); h1 = h((~isnan(h)));
    j = sdensity1(:,9)./sdensity1(:,14); j1 = j((~isnan(j)));
    k = sdensity1(:,10)./sdensity1(:,14); k1 = k((~isnan(k)));
    L = sdensity1(:,11)./sdensity1(:,14); L1 = L((~isnan(L))); 
    m = sdensity1(:,12)./sdensity1(:,14); m1 = m((~isnan(m))); 
    thirteen = sdensity1(:,13)./sdensity1(:,14); thirteen1 = thirteen((~isnan(thirteen)));
    ...
    a = sdensity2(:,1)./sdensity1(:,14); a1 = a((~isnan(a)));
    b = sdensity2(:,2)./sdensity1(:,14); b1 = b((~isnan(b)));
    c = sdensity2(:,3)./sdensity1(:,14); c1 = c((~isnan(c)));
    d = sdensity2(:,4)./sdensity1(:,14); d1 = d((~isnan(d)));
    e = sdensity2(:,5)./sdensity1(:,14); e1 = e((~isnan(e)));
    f = sdensity2(:,6)./sdensity1(:,14); f1 = f((~isnan(f)));
    g = sdensity2(:,7)./sdensity1(:,14); g1 = g((~isnan(g)));
    h = sdensity2(:,8)./sdensity1(:,14); h1 = h((~isnan(h)));
    j = sdensity2(:,9)./sdensity1(:,14); j1 = j((~isnan(j)));
    k = sdensity2(:,10)./sdensity1(:,14); k1 = k((~isnan(k)));
    L = sdensity2(:,11)./sdensity1(:,14); L1 = L((~isnan(L)));
    m = sdensity2(:,12)./sdensity1(:,14); m1 = m((~isnan(m)));parameter = 2*13 * (2/3);
    thirteen = sdensity2(:,13)./sdensity1(:,14); thirteen1 = thirteen((~isnan(thirteen)));
...
group13age_KDE = parameters_sort(:,1);
weight13age_KDE = parameters_sort(:,2);
sigma13age_KDE = parameters_sort(:,3);


result = log(weight13age_KDE(1).*distribution(data(:,1),sigma13age_KDE(1),group13age_KDE(1))+...
    weight13age_KDE(2).*distribution(data(:,1),sigma13age_KDE(2),group13age_KDE(2))+...
    weight13age_KDE(3).*distribution(data(:,1),sigma13age_KDE(3),group13age_KDE(3))+...
    weight13age_KDE(4).*distribution(data(:,1),sigma13age_KDE(4),group13age_KDE(4))+...
    weight13age_KDE(5).*distribution(data(:,1),sigma13age_KDE(5),group13age_KDE(5))+...
    weight13age_KDE(6).*distribution(data(:,1),sigma13age_KDE(6),group13age_KDE(6))+...
    weight13age_KDE(7).*distribution(data(:,1),sigma13age_KDE(7),group13age_KDE(7))+...
    weight13age_KDE(8).*distribution(data(:,1),sigma13age_KDE(8),group13age_KDE(8))+...
    weight13age_KDE(9).*distribution(data(:,1),sigma13age_KDE(9),group13age_KDE(9))+...
    weight13age_KDE(10).*distribution(data(:,1),sigma13age_KDE(10),group13age_KDE(10))+...
    weight13age_KDE(11).*distribution(data(:,1),sigma13age_KDE(11),group13age_KDE(11))+...
    weight13age_KDE(12).*distribution(data(:,1),sigma13age_KDE(12),group13age_KDE(12))+...
    weight13age_KDE(13).*distribution(data(:,1),sigma13age_KDE(13),group13age_KDE(13)));

result1 = result((~isinf(result)));

Likelihood13KDE = sum(result1);

BIC13_KDE = -2*Likelihood13KDE+parameter*log(n);
end