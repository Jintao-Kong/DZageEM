%% yield sigmaage k = 8
function [sigmaage,sigmaall] = confidence8KDE1(data,weight,group,sigma)

deltaweight = 0.001; deltaage = 0.1; 
bzc = [sigma(1),sigma(2),sigma(3),sigma(4),sigma(5),sigma(6),sigma(7),sigma(8)];
...
sigma11 = (sum(sigma111)+sum(sigma112)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma22 = (sum(sigma221)+sum(sigma222)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma33 = (sum(sigma331)+sum(sigma332)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma44 = (sum(sigma441)+sum(sigma442)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma55 = (sum(sigma551)+sum(sigma552)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma66 = (sum(sigma661)+sum(sigma662)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma77 = (sum(sigma771)+sum(sigma772)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma88 = (sum(sigma881)+sum(sigma882)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma99 = (sum(sigma991)+sum(sigma992)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma1010 = (sum(sigma10101)+sum(sigma10102)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma1111 = (sum(sigma11111)+sum(sigma11112)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma12122(:,1) = -log(weight(1).*distribution(data(:,1),bzc(1),group(1))+...
    weight(2).*distribution(data(:,1),bzc(2),group(2))+...
    weight(3).*distribution(data(:,1),bzc(3),group(3))+...
    weight(4).*distribution(data(:,1),bzc(4),group(4))+...
    weight(5).*distribution(data(:,1),bzc(5),group(5))+...
...
sigma1212 = (sum(sigma12121)+sum(sigma12122)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma1313 = (sum(sigma13131)+sum(sigma13132)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma1414 = (sum(sigma14141)+sum(sigma14142)-2.*Likelihood8KDE)./(deltaweight.^2);
...
sigma1515 = (sum(sigma15151)+sum(sigma15152)-2.*Likelihood8KDE)./(deltaage.^2);
...
sigma1616 = (sum(sigma16161)+sum(sigma16162)-2.*Likelihood8KDE)./(deltaweight.^2);

sigma = [sigma11;sigma22;sigma33;sigma44;sigma55;sigma66;sigma77;sigma88;sigma99;sigma1010;sigma1111;...
    sigma1212;sigma1313;sigma1414;sigma1515;sigma1616];
