%k=16;KDE
function [weight16age_KDE, sigma16age_KDE, group16age_KDE, BIC16_KDE]...
    = ML16KDE (data,initialgroup,iteration)
% initial number need to be checked
initialweight = ones(1,16).*(1/16);
initialsigma = ones(1,16).*15;
...
for i = 1:iteration
    ...
    alphadensity(:,17) = alphadensity(:,1) + alphadensity(:,2) + alphadensity(:,3) + alphadensity(:,4)...
        ...
        + alphadensity(:,10) + alphadensity(:,11) + alphadensity(:,12) + alphadensity(:,13) + alphadensity(:,14)...
         + alphadensity(:,15) + alphadensity(:,16);
    
    a = alphadensity(:,1)./alphadensity(:,17); a1 = a((~isnan(a)));
    b = alphadensity(:,2)./alphadensity(:,17); b1 = b((~isnan(b)));
    c = alphadensity(:,3)./alphadensity(:,17); c1 = c((~isnan(c)));
    d = alphadensity(:,4)./alphadensity(:,17); d1 = d((~isnan(d)));
    e = alphadensity(:,5)./alphadensity(:,17); e1 = e((~isnan(e)));
    f = alphadensity(:,6)./alphadensity(:,17); f1 = f((~isnan(f)));
    g = alphadensity(:,7)./alphadensity(:,17); g1 = g((~isnan(g)));
    h = alphadensity(:,8)./alphadensity(:,17); h1 = h((~isnan(h)));
    j = alphadensity(:,9)./alphadensity(:,17); j1 = j((~isnan(j)));
    k = alphadensity(:,10)./alphadensity(:,17); k1 = k((~isnan(k)));
    L = alphadensity(:,11)./alphadensity(:,17); L1 = L((~isnan(L)));
    m = alphadensity(:,12)./alphadensity(:,17); m1 = m((~isnan(m)));
    thirteen = alphadensity(:,13)./alphadensity(:,17); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = alphadensity(:,14)./alphadensity(:,17); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = alphadensity(:,15)./alphadensity(:,17); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = alphadensity(:,16)./alphadensity(:,17); sixteen1 = sixteen((~isnan(sixteen)));
    ...
    miudensity1(:,17) = miudensity1(:,1) + miudensity1(:,2) + miudensity1(:,3) + miudensity1(:,4)...
        ...
        + miudensity1(:,10) + miudensity1(:,11) + miudensity1(:,12) + miudensity1(:,13) + miudensity1(:,14)...
         + miudensity1(:,15) + miudensity1(:,16);
    
    a = miudensity1(:,1)./miudensity1(:,17); a1 = a((~isnan(a)));
    b = miudensity1(:,2)./miudensity1(:,17); b1 = b((~isnan(b)));
    c = miudensity1(:,3)./miudensity1(:,17); c1 = c((~isnan(c)));
    d = miudensity1(:,4)./miudensity1(:,17); d1 = d((~isnan(d)));
    e = miudensity1(:,5)./miudensity1(:,17); e1 = e((~isnan(e)));
    f = miudensity1(:,6)./miudensity1(:,17); f1 = f((~isnan(f)));
    g = miudensity1(:,7)./miudensity1(:,17); g1 = g((~isnan(g)));
    h = miudensity1(:,8)./miudensity1(:,17); h1 = h((~isnan(h)));
    j = miudensity1(:,9)./miudensity1(:,17); j1 = j((~isnan(j)));
    k = miudensity1(:,10)./miudensity1(:,17); k1 = k((~isnan(k)));
    L = miudensity1(:,11)./miudensity1(:,17); L1 = L((~isnan(L)));
    m = miudensity1(:,12)./miudensity1(:,17); m1 = m((~isnan(m)));
    thirteen = miudensity1(:,13)./miudensity1(:,17); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = miudensity1(:,14)./miudensity1(:,17); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = miudensity1(:,15)./miudensity1(:,17); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = miudensity1(:,16)./miudensity1(:,17); sixteen1 = sixteen((~isnan(sixteen)));
    ...
    a = miudensity2(:,1)./miudensity1(:,17); a1 = a((~isnan(a)));
    b = miudensity2(:,2)./miudensity1(:,17); b1 = b((~isnan(b)));
    c = miudensity2(:,3)./miudensity1(:,17); c1 = c((~isnan(c)));
    d = miudensity2(:,4)./miudensity1(:,17); d1 = d((~isnan(d)));
    e = miudensity2(:,5)./miudensity1(:,17); e1 = e((~isnan(e)));
    f = miudensity2(:,6)./miudensity1(:,17); f1 = f((~isnan(f)));
    g = miudensity2(:,7)./miudensity1(:,17); g1 = g((~isnan(g)));
    h = miudensity2(:,8)./miudensity1(:,17); h1 = h((~isnan(h)));
    j = miudensity2(:,9)./miudensity1(:,17); j1 = j((~isnan(j)));
    k = miudensity2(:,10)./miudensity1(:,17); k1 = k((~isnan(k)));
    L = miudensity2(:,11)./miudensity1(:,17); L1 = L((~isnan(L)));
    m = miudensity2(:,12)./miudensity1(:,17); m1 = m((~isnan(m)));
    thirteen = miudensity2(:,13)./miudensity1(:,17); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = miudensity2(:,14)./miudensity1(:,17); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = miudensity2(:,15)./miudensity1(:,17); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = miudensity2(:,16)./miudensity1(:,17); sixteen1 = sixteen((~isnan(sixteen)));
    ...
    sdensity1(:,17) = sdensity1(:,1) + sdensity1(:,2) + sdensity1(:,3) + sdensity1(:,4)...
        ...
        + sdensity1(:,10) + sdensity1(:,11) + sdensity1(:,12) + sdensity1(:,13) + sdensity1(:,14)...
         + sdensity1(:,15) + sdensity1(:,16);parameter = 2*16 * (2/3);

    a = sdensity1(:,1)./sdensity1(:,17); a1 = a((~isnan(a)));
    b = sdensity1(:,2)./sdensity1(:,17); b1 = b((~isnan(b)));
    c = sdensity1(:,3)./sdensity1(:,17); c1 = c((~isnan(c)));
    d = sdensity1(:,4)./sdensity1(:,17); d1 = d((~isnan(d)));
    e = sdensity1(:,5)./sdensity1(:,17); e1 = e((~isnan(e)));
    f = sdensity1(:,6)./sdensity1(:,17); f1 = e((~isnan(f)));
    g = sdensity1(:,7)./sdensity1(:,17); g1 = g((~isnan(g)));
    h = sdensity1(:,8)./sdensity1(:,17); h1 = h((~isnan(h)));
    j = sdensity1(:,9)./sdensity1(:,17); j1 = j((~isnan(j)));
    k = sdensity1(:,10)./sdensity1(:,17); k1 = k((~isnan(k)));
    L = sdensity1(:,11)./sdensity1(:,17); L1 = L((~isnan(L))); 
    m = sdensity1(:,12)./sdensity1(:,17); m1 = m((~isnan(m))); 
    thirteen = sdensity1(:,13)./sdensity1(:,17); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = sdensity1(:,14)./sdensity1(:,17); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = sdensity1(:,15)./sdensity1(:,17); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = sdensity1(:,16)./sdensity1(:,17); sixteen1 = sixteen((~isnan(sixteen)));
    ...
    a = sdensity2(:,1)./sdensity1(:,17); a1 = a((~isnan(a)));
    b = sdensity2(:,2)./sdensity1(:,17); b1 = b((~isnan(b)));
    c = sdensity2(:,3)./sdensity1(:,17); c1 = c((~isnan(c)));
    d = sdensity2(:,4)./sdensity1(:,17); d1 = d((~isnan(d)));
    e = sdensity2(:,5)./sdensity1(:,17); e1 = e((~isnan(e)));
    f = sdensity2(:,6)./sdensity1(:,17); f1 = f((~isnan(f)));
    g = sdensity2(:,7)./sdensity1(:,17); g1 = g((~isnan(g)));
    h = sdensity2(:,8)./sdensity1(:,17); h1 = h((~isnan(h)));
    j = sdensity2(:,9)./sdensity1(:,17); j1 = j((~isnan(j)));
    k = sdensity2(:,10)./sdensity1(:,17); k1 = k((~isnan(k)));
    L = sdensity2(:,11)./sdensity1(:,17); L1 = L((~isnan(L)));
    m = sdensity2(:,12)./sdensity1(:,17); m1 = m((~isnan(m)));
    thirteen = sdensity2(:,13)./sdensity1(:,17); thirteen1 = thirteen((~isnan(thirteen)));
    fourteen = sdensity2(:,14)./sdensity1(:,17); fourteen1 = fourteen((~isnan(fourteen)));
    fifteen = sdensity2(:,15)./sdensity1(:,17); fifteen1 = fifteen((~isnan(fifteen)));
    sixteen = sdensity2(:,16)./sdensity1(:,17); sixteen1 = sixteen((~isnan(sixteen)));
...
group16age_KDE = parameters_sort(:,1);
weight16age_KDE = parameters_sort(:,2);
sigma16age_KDE = parameters_sort(:,3);

no = 16;

result = log(weight16age_KDE(1).*distribution(data(:,1),sigma16age_KDE(1),group16age_KDE(1))+...
    weight16age_KDE(2).*distribution(data(:,1),sigma16age_KDE(2),group16age_KDE(2))+...
    weight16age_KDE(3).*distribution(data(:,1),sigma16age_KDE(3),group16age_KDE(3))+...
    weight16age_KDE(4).*distribution(data(:,1),sigma16age_KDE(4),group16age_KDE(4))+...
    weight16age_KDE(5).*distribution(data(:,1),sigma16age_KDE(5),group16age_KDE(5))+...
    weight16age_KDE(6).*distribution(data(:,1),sigma16age_KDE(6),group16age_KDE(6))+...
    weight16age_KDE(7).*distribution(data(:,1),sigma16age_KDE(7),group16age_KDE(7))+...
    weight16age_KDE(8).*distribution(data(:,1),sigma16age_KDE(8),group16age_KDE(8))+...
    weight16age_KDE(9).*distribution(data(:,1),sigma16age_KDE(9),group16age_KDE(9))+...
    weight16age_KDE(10).*distribution(data(:,1),sigma16age_KDE(10),group16age_KDE(10))+...
    weight16age_KDE(11).*distribution(data(:,1),sigma16age_KDE(11),group16age_KDE(11))+...
    weight16age_KDE(12).*distribution(data(:,1),sigma16age_KDE(12),group16age_KDE(12))+...
    weight16age_KDE(13).*distribution(data(:,1),sigma16age_KDE(13),group16age_KDE(13))+...
    weight16age_KDE(14).*distribution(data(:,1),sigma16age_KDE(14),group16age_KDE(14))+...
    weight16age_KDE(15).*distribution(data(:,1),sigma16age_KDE(15),group16age_KDE(15))+...
    weight16age_KDE(16).*distribution(data(:,1),sigma16age_KDE(16),group16age_KDE(16)));
result1 = result((~isinf(result))); 
Likelihood16KDE = sum(result1);

BIC16_KDE = -2*Likelihood16KDE+parameter.*log(n);
end