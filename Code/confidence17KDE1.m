%% yield sigmaage k = 17
function [sigmaage,sigmaall] = confidence17KDE1(data,weight,group,sigma)
...
bzc = [sigma(1),sigma(2),sigma(3),sigma(4),sigma(5),sigma(6),...
    ...
    sigma(14),sigma(15),sigma(16),sigma(17)];
...
sigma11 = (sum(sigma111)+sum(sigma112)-2.*Likelihood17)./(deltaage.^2);
...
sigma22 = (sum(sigma221)+sum(sigma222)-2.*Likelihood17)./(deltaweight.^2);
...
sigma33 = (sum(sigma331)+sum(sigma332)-2.*Likelihood17)./(deltaage.^2);
...
sigma44 = (sum(sigma441)+sum(sigma442)-2.*Likelihood17)./(deltaweight.^2);
...
sigma55 = (sum(sigma551)+sum(sigma552)-2.*Likelihood17)./(deltaage.^2);
...
sigma66 = (sum(sigma661)+sum(sigma662)-2.*Likelihood17)./(deltaweight.^2);
...
sigma77 = (sum(sigma771)+sum(sigma772)-2.*Likelihood17)./(deltaage.^2);
...
sigma88 = (sum(sigma881)+sum(sigma882)-2.*Likelihood17)./(deltaweight.^2);
...
sigma99 = (sum(sigma991)+sum(sigma992)-2.*Likelihood17)./(deltaage.^2);
...
sigma1010 = (sum(sigma10101)+sum(sigma10102)-2.*Likelihood17)./(deltaweight.^2);
...
sigma1111 = (sum(sigma11111)+sum(sigma11112)-2.*Likelihood17)./(deltaage.^2);
...
sigma1212 = (sum(sigma12121)+sum(sigma12122)-2.*Likelihood17)./(deltaweight.^2);
...
sigma1313 = (sum(sigma13131)+sum(sigma13132)-2.*Likelihood17)./(deltaage.^2);
...
sigma1414 = (sum(sigma14141)+sum(sigma14142)-2.*Likelihood17)./(deltaweight.^2);
...
sigma1515 = (sum(sigma15151)+sum(sigma15152)-2.*Likelihood17)./(deltaage.^2);
...
sigma1616 = (sum(sigma16161)+sum(sigma16162)-2.*Likelihood17)./(deltaweight.^2);
...
sigma1717 = (sum(sigma17171)+sum(sigma17172)-2.*Likelihood17)./(deltaage.^2);
...
sigma1818 = (sum(sigma18181)+sum(sigma18182)-2.*Likelihood17)./(deltaweight.^2);
...
sigma1919 = (sum(sigma19191)+sum(sigma19192)-2.*Likelihood17)./(deltaage.^2);
...
sigma2020 = (sum(sigma20201)+sum(sigma20202)-2.*Likelihood17)./(deltaweight.^2);
...
sigma2121 = (sum(sigma21211)+sum(sigma21212)-2.*Likelihood17)./(deltaage.^2);
...
sigma2222 = (sum(sigma22221)+sum(sigma22222)-2.*Likelihood17)./(deltaweight.^2);
...
sigma2323 = (sum(sigma23231)+sum(sigma23232)-2.*Likelihood17)./(deltaage.^2);
...
sigma2424 = (sum(sigma24241)+sum(sigma24242)-2.*Likelihood17)./(deltaweight.^2);
...
sigma2525 = (sum(sigma25251)+sum(sigma25252)-2.*Likelihood17)./(deltaage.^2);
...
sigma2626 = (sum(sigma26261)+sum(sigma26262)-2.*Likelihood17)./(deltaweight.^2);
...
sigma2727 = (sum(sigma27271)+sum(sigma27272)-2.*Likelihood17)./(deltaage.^2);
...
sigma2828 = (sum(sigma28281)+sum(sigma28282)-2.*Likelihood17)./(deltaweight.^2);
...
sigma2929 = (sum(sigma29291)+sum(sigma29292)-2.*Likelihood17)./(deltaage.^2);
...
sigma3030 = (sum(sigma30301)+sum(sigma30302)-2.*Likelihood17)./(deltaweight.^2);
...
sigma3131 = (sum(sigma31311)+sum(sigma31312)-2.*Likelihood17)./(deltaage.^2);
...
sigma3232 = (sum(sigma32321)+sum(sigma32322)-2.*Likelihood17)./(deltaweight.^2);
...
sigma3333 = (sum(sigma33331)+sum(sigma33332)-2.*Likelihood17)./(deltaage.^2);
...
sigma3434 = (sum(sigma34341)+sum(sigma34342)-2.*Likelihood17)./(deltaweight.^2);
