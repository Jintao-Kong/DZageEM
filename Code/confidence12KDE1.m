%% yield sigmaage k = 12
function [sigmaage,sigmaall] = confidence12KDE1(data,weight,group,sigma)
...
sigma11 = (sum(sigma111)+sum(sigma112)-2.*Likelihood12)./(deltaage.^2);
...
sigma22 = (sum(sigma221)+sum(sigma222)-2.*Likelihood12)./(deltaweight.^2);
...
sigma33 = (sum(sigma331)+sum(sigma332)-2.*Likelihood12)./(deltaage.^2);
...
sigma44 = (sum(sigma441)+sum(sigma442)-2.*Likelihood12)./(deltaweight.^2);
...
sigma55 = (sum(sigma551)+sum(sigma552)-2.*Likelihood12)./(deltaage.^2);
...
sigma66 = (sum(sigma661)+sum(sigma662)-2.*Likelihood12)./(deltaweight.^2);
...
sigma77 = (sum(sigma771)+sum(sigma772)-2.*Likelihood12)./(deltaage.^2);
...
sigma88 = (sum(sigma881)+sum(sigma882)-2.*Likelihood12)./(deltaweight.^2);
...
sigma99 = (sum(sigma991)+sum(sigma992)-2.*Likelihood12)./(deltaage.^2);
...
sigma1010 = (sum(sigma10101)+sum(sigma10102)-2.*Likelihood12)./(deltaweight.^2);
...
sigma1111 = (sum(sigma11111)+sum(sigma11112)-2.*Likelihood12)./(deltaage.^2);
...
sigma1212 = (sum(sigma12121)+sum(sigma12122)-2.*Likelihood12)./(deltaweight.^2);
...
sigma1313 = (sum(sigma13131)+sum(sigma13132)-2.*Likelihood12)./(deltaage.^2);
...
sigma1414 = (sum(sigma14141)+sum(sigma14142)-2.*Likelihood12)./(deltaweight.^2);
...
sigma1515 = (sum(sigma15151)+sum(sigma15152)-2.*Likelihood12)./(deltaage.^2);
...
sigma1616 = (sum(sigma16161)+sum(sigma16162)-2.*Likelihood12)./(deltaweight.^2);
...
sigma1717 = (sum(sigma17171)+sum(sigma17172)-2.*Likelihood12)./(deltaage.^2);
...
sigma1818 = (sum(sigma18181)+sum(sigma18182)-2.*Likelihood12)./(deltaweight.^2);
...
sigma1919 = (sum(sigma19191)+sum(sigma19192)-2.*Likelihood12)./(deltaage.^2);
...
sigma2020 = (sum(sigma20201)+sum(sigma20202)-2.*Likelihood12)./(deltaweight.^2);
...
sigma2121 = (sum(sigma21211)+sum(sigma21212)-2.*Likelihood12)./(deltaage.^2);
...
sigma2222 = (sum(sigma22221)+sum(sigma22222)-2.*Likelihood12)./(deltaweight.^2);
...
sigma2323 = (sum(sigma23231)+sum(sigma23232)-2.*Likelihood12)./(deltaage.^2);
...
sigma2424 = (sum(sigma24241)+sum(sigma24242)-2.*Likelihood12)./(deltaweight.^2);
