%k=8;KDE
function [weight8age_KDE, sigma8age_KDE, group8age_KDE, BIC8_KDE]...
    = ML8KDE (data,initialgroup,iteration)
% initial number need to be checked
initialweight = [0.1,0.2,0.1,0.1,0.2,0.1,0.1,0.1];
initialsigma = [15,20,20,20,25,25,25,30];
...
for i = 1:iteration
    ...
    alphadensity(:,9) = alphadensity(:,1) + alphadensity(:,2) + alphadensity(:,3) + alphadensity(:,4)...
        + alphadensity(:,5) + alphadensity(:,6) + alphadensity(:,7) + alphadensity(:,8);
    a = alphadensity(:,1)./alphadensity(:,9); a1 = a((~isnan(a)));
    b = alphadensity(:,2)./alphadensity(:,9); b1 = b((~isnan(b)));
    c = alphadensity(:,3)./alphadensity(:,9); c1 = c((~isnan(c)));
    d = alphadensity(:,4)./alphadensity(:,9); d1 = d((~isnan(d)));
    e = alphadensity(:,5)./alphadensity(:,9); e1 = e((~isnan(e)));
    f = alphadensity(:,6)./alphadensity(:,9); f1 = f((~isnan(f)));
    g = alphadensity(:,7)./alphadensity(:,9); g1 = g((~isnan(g)));
    h = alphadensity(:,8)./alphadensity(:,9); h1 = h((~isnan(h)));
    ...
    miudensity1(:,9) = miudensity1(:,1) + miudensity1(:,2) + miudensity1(:,3) + miudensity1(:,4)...
        + miudensity1(:,5) + miudensity1(:,6) + miudensity1(:,7) + miudensity1(:,8);
    
    a = miudensity1(:,1)./miudensity1(:,9); a1 = a((~isnan(a)));
    b = miudensity1(:,2)./miudensity1(:,9); b1 = b((~isnan(b)));
    c = miudensity1(:,3)./miudensity1(:,9); c1 = c((~isnan(c)));
    d = miudensity1(:,4)./miudensity1(:,9); d1 = d((~isnan(d)));
    e = miudensity1(:,5)./miudensity1(:,9); e1 = e((~isnan(e)));
    f = miudensity1(:,6)./miudensity1(:,9); f1 = f((~isnan(f)));
    g = miudensity1(:,7)./miudensity1(:,9); g1 = g((~isnan(g)));
    h = miudensity1(:,8)./miudensity1(:,9); h1 = h((~isnan(h)));sample_size = 2*n;
    ...
    a = miudensity2(:,1)./miudensity1(:,9); a1 = a((~isnan(a)));
    b = miudensity2(:,2)./miudensity1(:,9); b1 = b((~isnan(b)));
    c = miudensity2(:,3)./miudensity1(:,9); c1 = c((~isnan(c)));
    d = miudensity2(:,4)./miudensity1(:,9); d1 = d((~isnan(d)));
    e = miudensity2(:,5)./miudensity1(:,9); e1 = e((~isnan(e)));
    f = miudensity2(:,6)./miudensity1(:,9); f1 = f((~isnan(f)));
    g = miudensity2(:,7)./miudensity1(:,9); g1 = g((~isnan(g)));
    h = miudensity2(:,8)./miudensity1(:,9); h1 = h((~isnan(h)));
    ...
    sdensity1(:,9) = sdensity1(:,1) + sdensity1(:,2) + sdensity1(:,3) + sdensity1(:,4)...
        + sdensity1(:,5) + sdensity1(:,6) + sdensity1(:,7) + sdensity1(:,8);
    
    a = sdensity1(:,1)./sdensity1(:,9); a1 = a((~isnan(a)));parameter = 16;
    b = sdensity1(:,2)./sdensity1(:,9); b1 = b((~isnan(b)));
    c = sdensity1(:,3)./sdensity1(:,9); c1 = c((~isnan(c)));
    d = sdensity1(:,4)./sdensity1(:,9); d1 = d((~isnan(d)));
    e = sdensity1(:,5)./sdensity1(:,9); e1 = e((~isnan(e)));
    f = sdensity1(:,6)./sdensity1(:,9); f1 = f((~isnan(f)));
    g = sdensity1(:,7)./sdensity1(:,9); g1 = g((~isnan(g)));
    h = sdensity1(:,8)./sdensity1(:,9); h1 = h((~isnan(h)));
    ...
    a = sdensity2(:,1)./sdensity1(:,9); a1 = a((~isnan(a)));
    b = sdensity2(:,2)./sdensity1(:,9); b1 = b((~isnan(b)));
    c = sdensity2(:,3)./sdensity1(:,9); c1 = c((~isnan(c)));
    d = sdensity2(:,4)./sdensity1(:,9); d1 = d((~isnan(d)));
    e = sdensity2(:,5)./sdensity1(:,9); e1 = e((~isnan(e)));
    f = sdensity2(:,6)./sdensity1(:,9); f1 = f((~isnan(f)));
    g = sdensity2(:,7)./sdensity1(:,9); g1 = g((~isnan(g)));
    h = sdensity2(:,8)./sdensity1(:,9); h1 = h((~isnan(h)));
...
group8age_KDE = parameters_sort(:,1);
weight8age_KDE = parameters_sort(:,2);
sigma8age_KDE = parameters_sort(:,3);


result = log(weight8age_KDE(1).*distribution(data(:,1),sigma8age_KDE(1),group8age_KDE(1))+...
    weight8age_KDE(2).*distribution(data(:,1),sigma8age_KDE(2),group8age_KDE(2))+...
    weight8age_KDE(3).*distribution(data(:,1),sigma8age_KDE(3),group8age_KDE(3))+...
    weight8age_KDE(4).*distribution(data(:,1),sigma8age_KDE(4),group8age_KDE(4))+...
    weight8age_KDE(5).*distribution(data(:,1),sigma8age_KDE(5),group8age_KDE(5))+...
    weight8age_KDE(6).*distribution(data(:,1),sigma8age_KDE(6),group8age_KDE(6))+...
    weight8age_KDE(7).*distribution(data(:,1),sigma8age_KDE(7),group8age_KDE(7))+...
    weight8age_KDE(8).*distribution(data(:,1),sigma8age_KDE(8),group8age_KDE(8)));

result1 = result((~isinf(result)));
Likelihood8KDE = sum(result1);

BIC8_KDE = -2*Likelihood8KDE+parameter.*log(sample_size);
end
